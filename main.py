...
parser.add_argument('-t', '--test', help='huffman test file', action='store_true')
...
try:
    if args.decompress:
        ...
        path_comp = HuffmanCompress(path).compress(directory_key_codes=directory_key, test_key=args.test)
